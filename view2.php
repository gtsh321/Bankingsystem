...
<div class="container border border-secondary">
  ...
  <div class="clearfix py-md-5">
    <div class="float-sm-left "><span class="font-weight-bold">Name</span>: Jacob</div><br>
    <div class="float-md-left "><span class="font-weight-bold">Age</span>: 25</div><br>
    <div class="float-md-right "><img src="customer1.jpg" class="rounded-circle" alt="Cinque Terre" width="204" height="156"></div>
    <div class="float-lg-leftt"><span class="font-weight-bold">Email</span>: jacob_81@gmail.com</div><br>
    <div class="float-lg-left"><span class="font-weight-bold">Current Balance</span>: 45000</div><br>
    <div class="float-xl-left"><span class="font-weight-bold">Mobile Number</span>: 95634777888</div><br>
    <div class="float-xl-left"><span class="font-weight-bold">Address</span>: Haryana</div><br>
